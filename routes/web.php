...
Route::group(['middleware' => ['auth']], function() {
    Route::group(['middleware' => ['pakar']], function(){
        ...
        Route::get('/hasil_pdf/{id}',[App\Http\Controllers\HasilController::class, 'pdf'])->name('hasil_pdf');
    ...
    Route::group(['middleware' => ['user']], function(){
        ...
        Route::get('/change_password', [App\Http\Controllers\UserController::class, 'changepw'])->name('changepw');
        Route::put('/change_password', [App\Http\Controllers\UserController::class, 'change_password'])->name('change_password');
        ...
        Route::get('/riwayat/{id_user}', [App\Http\Controllers\HasilController::class, 'index'])->name('riwayat');
        Route::get('/pengaturan', [App\Http\Controllers\DashboardController::class, 'index'])->name('pengaturan');
        ...
        // Route::post('/konsultasi/{kat}/{urut}', [App\Http\Controllers\GejalaController::class, 'r1'])->name('r1');
        ...
        //PENGATURAN
        Route::get('/pengaturan', [App\Http\Controllers\DashboardController::class, 'pengaturan'])->name('pengaturan');
        
        Route::get('/selesai', [App\Http\Controllers\GejalaController::class, 'selesai'])->name('selesai');

        Route::get('/update_profile', [App\Http\Controllers\UserController::class, 'index'])->name('update_profile');
        Route::post('/update_profile/{id}', [App\Http\Controllers\UserController::class, 'update_profile'])->name('update_profil');
    });
});